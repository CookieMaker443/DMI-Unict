...
typedef struct{
    int **card; //la mattrice della carta
    int current_number; //numero che esce
    int player_id_bingo; //id del player che ha fatto bingo
    int player_id_quintet; //id del player che ha fatto cinquina
    int is_quintet; //Flag per cinquina già vinta
