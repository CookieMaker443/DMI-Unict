...
typedef struct {
    ...
    // mutex per gestire l'accesso con mutua esclusione alla struttura dati condivisa
    pthread_mutex_t lock;

    // variabili conidizone necessarie per gestire la sincronizzazione senza spin lock
